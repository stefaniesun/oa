...
$(function () {
   ...
   $(".J_menuItem").each(function (index) {
    ...
    function menuItem() {
        ...
        $(".J_menuItem").parent("li").removeClass('active');
        ...
        if (flag) {
	        ...
	        if(dataIndex==0){
	        	 ...
	        	 alert( $('.J_menuTab').children("a:eq(0)").html());
	        	 $('.J_menuTab a:eq(0)').addClass('active');
	        	return false;
	        }
    ...
    function activeTab() {
        ...
        $(".J_menuItem").parent("li").removeClass('active');
        $(".J_menuItem[data-index="+$(this).data('index')+"]").parent("li").attr("class","active");
    }
